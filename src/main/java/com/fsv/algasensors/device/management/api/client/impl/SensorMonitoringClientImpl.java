package com.fsv.algasensors.device.management.api.client.impl;

import com.fsv.algasensors.device.management.api.client.RestClientFactory;
...
public class SensorMonitoringClientImpl implements SensorMonitoringClient {
    ...
    public SensorMonitoringClientImpl(RestClientFactory restClientFactory) {
        this.restClient = restClientFactory.temperatureMonitoringClient();
    }
